...
namespace Tools.MaxCore.Tools.SerializableComponent
{
	...
	public abstract class SerializableDictionaryBase<TKey, TValue, TValueStorage> : SerializableDictionaryBase, IDictionary<TKey, TValue>, IDictionary, ISerializationCallbackReceiver, IDeserializationCallback, ISerializable
	{
		...
		public ICollection<TKey> Keys =>
			((IDictionary<TKey, TValue>)m_dict).Keys;
		public ICollection<TValue> Values => 
			((IDictionary<TKey, TValue>)m_dict).Values;
		public int Count => 
			((IDictionary<TKey, TValue>)m_dict).Count;
		public bool IsReadOnly => 
			((IDictionary<TKey, TValue>)m_dict).IsReadOnly;
		...
		public bool ContainsKey(TKey key) => 
			((IDictionary<TKey, TValue>)m_dict).ContainsKey(key);

		public bool Remove(TKey key) => 
			((IDictionary<TKey, TValue>)m_dict).Remove(key);
		...
		public bool Contains(KeyValuePair<TKey, TValue> item) => 
			((IDictionary<TKey, TValue>)m_dict).Contains(item);

		public void CopyTo(KeyValuePair<TKey, TValue>[] array, int arrayIndex) => 
			((IDictionary<TKey, TValue>)m_dict).CopyTo(array, arrayIndex);

		public bool Remove(KeyValuePair<TKey, TValue> item) => 
			((IDictionary<TKey, TValue>)m_dict).Remove(item);

		public IEnumerator<KeyValuePair<TKey, TValue>> GetEnumerator() => 
			((IDictionary<TKey, TValue>)m_dict).GetEnumerator();
		...
		public bool IsFixedSize => 
			((IDictionary)m_dict).IsFixedSize;
		ICollection IDictionary.Keys =>
			((IDictionary)m_dict).Keys;
		ICollection IDictionary.Values => 
			((IDictionary)m_dict).Values;
		public bool IsSynchronized => 
			((IDictionary)m_dict).IsSynchronized;
		public object SyncRoot =>
			((IDictionary)m_dict).SyncRoot;
		...
		public bool Contains(object key) => 
			((IDictionary)m_dict).Contains(key);

		IDictionaryEnumerator IDictionary.GetEnumerator() => 
			((IDictionary)m_dict).GetEnumerator();
